...
export default function Form() {
    ...
    <div className="justify-center items-center border-2 border-solid border-blue-hosta rounded-3xl bg-blue-hosta ">
        <h1 className="text-5xl font-bold pt-10 flex flex-col items-center">Contact Us</h1>
        ...
        <div className="flex flex-row gap-44 pl-28 pt-10 pb-10">
            <button className="text-xl bg-dirty-blue rounded-xl flex items-center justify-center w-[250px] h-16 font-bold text-white hover:bg-ebony-clay">Book Appointment</button>
