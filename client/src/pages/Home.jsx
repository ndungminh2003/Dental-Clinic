...
export default function Home() {
  ...
  <div className="flex flex-col justify-center items-center w-full">
    <NavBar />
    <div className="flex flex-row my-10 border-2 border-solid border-blue-hosta rounded-[56px] w-[1760px] h-[800px] bg-blue-hosta">
    ...
    {/*Service*/}
    <div className="my-20 flex flex-col justify-center items-center gap-16">
      ...
      {/*Testimonial*/}
        <div className="ml-10 flex flex-row w-9/12 pt-20 ">
