            ...
            <div className='flex flex-col justify-center items-center gap-12 w-10/12'>
                ...
                <div className='flex flex-row gap-16'>
                        ...
                        <div className='flex flex-col gap-1 items-center'>
                            ...
                            <div className='text-3xl text-ebony-clay font-bold pt-5  '>DR.NGUYEN LE</div>
                            <div className='text-gray-500'>General & Cosmetic Dentist</div>
                        </div>
                        ...
                        <div className='flex flex-col gap-1 items-center'>
                            ...
                            <div className='text-3xl text-ebony-clay font-bold pt-5  '>DR.SOFYAN AMRABAT</div>
                            <div className='text-gray-500'>General & Cosmetic Dentist</div>
                        </div>
                ...
                <div className='flex flex-row gap-16'>
                        ...
                        <div className='flex flex-col gap-1 items-center'>
                            ...
                            <div className='text-3xl text-ebony-clay font-bold pt-5  '>DR.KHANH NGUYEN</div>
                            <div className='text-gray-500'>General & Cosmetic Dentist</div>
                        </div>
                        ...
                        <div className='flex flex-col gap-1 items-center'>
                            ...
                            <div className='text-3xl text-ebony-clay font-bold pt-5  '>DR.ISABELLA FLETCHER</div>
                            <div className='text-gray-500'>General & Cosmetic Dentist</div>
                        </div>
                        ...
                        <div className='flex flex-col gap-1 items-center'>
                            ...
                            <div className='text-3xl text-ebony-clay font-bold pt-5  '>DR.MINH NGUYEN</div>
                            <div className='text-gray-500'>General & Cosmetic Dentist</div>
                        </div>
